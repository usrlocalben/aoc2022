...
struct IVec2 {
  ...
  bool Equals(Object? other) {
    if (other is IVec2 instance) {
      return instance == this; }
    return false; }

  public static bool operator==(IVec2 lhs, IVec2 rhs) { return lhs.x==rhs.x && lhs.y==rhs.y; }
  public static bool operator!=(IVec2 lhs, IVec2 rhs) { return lhs.x!=rhs.x || lhs.y!=rhs.y; }

  public IVec2 Sign() { return new IVec2(Math.Sign(x), Math.Sign(y)); }

  public static IVec2 operator -(IVec2 a)              { IVec2 tmp; tmp.x = -a.x;          tmp.y = -a.y;          return tmp; }
...
struct IVec3 {
  public static
  IVec3 VMax(IVec3 a, IVec3 b) {
    return new IVec3(Math.Max(a.x, b.x), Math.Max(a.y, b.y), Math.Max(a.z, b.z)); }
  ...
  public override
  bool Equals(Object? other) {
    if (other is IVec3 instance) {
      return instance == this; }
    return false; }

  public static bool operator==(IVec3 lhs, IVec3 rhs) { return lhs.x==rhs.x && lhs.y==rhs.y && lhs.z==rhs.z; }
  public static bool operator!=(IVec3 lhs, IVec3 rhs) { return lhs.x!=rhs.x || lhs.y!=rhs.y || lhs.z!=rhs.z; }
